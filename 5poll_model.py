...
def get_poll_data(cutoff_date: str, time_trend_point: str, bundestag: bool):
    ...
    poll_df = poll_df[(poll_df['survey_date'] >= cutoff_date) & (poll_df['survey_date'] <= time_trend_point)]        
...
for time_trend_point in ["2024-11-13", "2024-11-23", "2024-12-03", "2024-12-13", "2024-12-23", "2025-01-03", "2025-01-13", "2025-01-23", "2025-02-03", "2025-02-13", "2025-02-23"]:

    baseline_polls = get_poll_data("2024-08-23", "2025-02-21", True)
    ...
    nation_polls = get_poll_data("2024-11-07", time_trend_point, True)
    ...
    summary.to_csv(f"/home/juliusd/documents/Quant-Econ/Bayesian_Modelling/Term_paper/results/trends/trends_{time_trend_point}")
    ...
    plt.savefig(f"/home/juliusd/documents/Quant-Econ/Bayesian_Modelling/Term_paper/results/trends/trends_{time_trend_point}")