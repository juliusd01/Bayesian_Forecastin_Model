...
for b in [0.5, 2, 5, 10]:
    ...
    with pm.Model() as nation_model:
        ...
        alpha_nation = pm.Gamma("alpha_nation", alpha=a_nation, beta=b, shape=8)    
        # Dirichlet-Prior
    ...
    summary_nation.to_csv(f"/home/juliusd/documents/Quant-Econ/Bayesian_Modelling/Term_paper/results/sensitivity/summary_b={b}.csv")
    ...
    plt.savefig(f"/home/juliusd/documents/Quant-Econ/Bayesian_Modelling/Term_paper/results/sensitivity/posterior_nation_b={b}.png")
